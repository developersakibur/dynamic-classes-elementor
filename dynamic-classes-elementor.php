            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => [
                        [
                            'name' => 'gap-10',
                            'row_gap' => 'clamp(8px, 7.43px + 0.18vw, 10px)',
                        ...
                        [
                            'name' => 'gap-30',
                            'row_gap' => 'clamp(15px, 10.71px + 1.34vw, 30px)',
                            'column_gap' => 'clamp(15px, 10.71px + 1.34vw, 30px)',
                        ],
                        [
                            'name' => 'gap-40',
                            'row_gap' => 'clamp(15px, 7.86px + 2.23vw, 40px)',
                            'column_gap' => 'clamp(15px, 7.86px + 2.23vw, 40px)',
                        ],
                        [
                            'name' => 'gap-50',
                            'row_gap' => 'clamp(15px, 5.00px + 3.13vw, 50px)',
                            'column_gap' => 'clamp(15px, 5.00px + 3.13vw, 50px)',
                        ],
                        [
                            'name' => 'gap-60',
                            'row_gap' => 'clamp(15px, 2.14px + 4.02vw, 60px)',
                            'column_gap' => 'clamp(15px, 2.14px + 4.02vw, 60px)',
                        ],
                        [
                            'name' => 'gap-80',
                            'row_gap' => 'clamp(15px, -3.57px + 5.80vw, 80px)',
                            'column_gap' => 'clamp(15px, -3.57px + 5.80vw, 80px)',
                        ],
                        [
                            'name' => 'gap-100',
                            'row_gap' => 'clamp(15px, -9.29px + 7.59vw, 100px)',
                            'column_gap' => 'clamp(15px, -9.29px + 7.59vw, 100px)',
                        ],
                    ],
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => [
                        [
                            'name' => 'padding-10-20',
                            'top' => 'clamp(5px, 3.57px + 0.45vw, 10px)',
                            'right' => 'clamp(15px, 13.57px + 0.45vw, 20px)',
                            'bottom' => 'clamp(5px, 3.57px + 0.45vw, 10px)',
                            'left' => 'clamp(15px, 13.57px + 0.45vw, 20px)',
                        ],
                        [
                            'name' => 'padding-20-20',
                            'top' => 'clamp(15px, 13.57px + 0.45vw, 20px)',
                            'right' => 'clamp(15px, 13.57px + 0.45vw, 20px)',
                            'bottom' => 'clamp(15px, 13.57px + 0.45vw, 20px)',
                            'left' => 'clamp(15px, 13.57px + 0.45vw, 20px)',
                        ],
                        [
                            'name' => 'padding-30-20',
                        ...
                        [
                            'name' => 'padding-80-20',
                            'top' => 'clamp(45px, 35.00px + 3.13vw, 80px)',
                            'right' => 'clamp(15px, 13.57px + 0.45vw, 20px)',
                            'bottom' => 'clamp(45px, 35.00px + 3.13vw, 80px)',
                            'left' => 'clamp(15px, 13.57px + 0.45vw, 20px)',
                        ],                       
                        [
                            'name' => 'padding-100-20',
                            'top' => 'clamp(55px, 42.14px + 4.02vw, 100px)',
                            'right' => 'clamp(15px, 13.57px + 0.45vw, 20px)',
                            'bottom' => 'clamp(55px, 42.14px + 4.02vw, 100px)',
                            'left' => 'clamp(15px, 13.57px + 0.45vw, 20px)',
                        ],
                    ],
