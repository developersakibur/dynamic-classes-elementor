...
//   4. AJAX Handler     – export / import / reset
//   5. Settings Page    – WP submenu admin page
//   6. Plugin           – wires everything together
//
// class-settings-tab.php is loaded lazily inside
// DCE_Plugin::register_settings_tab_class() because it extends
// Tab_Base which only exists after elementor/init fires.
...
require_once DCE_PLUGIN_DIR . 'includes/class-ajax-handler.php';
require_once DCE_PLUGIN_DIR . 'includes/class-settings-page.php';
